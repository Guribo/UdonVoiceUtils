...
namespace TLP.UdonVoiceUtils.Runtime.Core
{
    ...
    public class PlayerAudioOverride : TlpBaseBehaviour
    {
        ...
        [Range(0, 1)]
        [Tooltip(
            "Occlusion when a player is occluded by another player. A value of 1.0 means occlusion is off." +
            " A value of 0 will reduce the max. audible range of the voice/player to the current distance and" +
